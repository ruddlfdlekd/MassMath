	  ...
	  <div class="col-sm-2 sidenav">
	   <div class="scroll">
		...
		<select class="chapter_m" id="c_1" >
			<option id="op_1" value="">다항식의 연산</option>
        ...
        <div class="container">
          ...
          <form role="form" name="al_frm">
            <div class="form-group">
              ...
              <input type="text" class="form-control" id="al1" placeholder="Enter AnswerList">
            </div>
            <div class="answerList_result" title="al1"></div>
            <div class="form-group">
              <label for="psw"><span class="glyphicon glyphicon-eye-open"></span> 2번보기</label>
              <input type="text" class="form-control" id="al2" placeholder="Enter AnswerList">
            </div>
            <div class="answerList_result" title="al2"></div>
            <div class="form-group">
              <label for="psw"><span class="glyphicon glyphicon-eye-open"></span> 3번보기</label>
              <input type="text" class="form-control" id="al3" placeholder="Enter AnswerList">
            </div>
            <div class="answerList_result" title="al3"></div>
            <div class="form-group">
              <label for="psw"><span class="glyphicon glyphicon-eye-open"></span> 4번보기</label>
              <input type="text" class="form-control" id="al4" placeholder="Enter AnswerList">
            </div>
            <div class="answerList_result" title="al4"></div>
              <input type="button" id="answerList_btn" class="btn btn-primary btn-block" style="margin-top: 10px;" value="insert">
          </form>
        </div>
      </div>
